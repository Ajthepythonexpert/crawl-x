...
try:
    ...
    def render():
        ...
        st.success("🎯 Diagnostic Mode: File parsing and imports completed successfully!")
    ...
    # This function will run if the script crashes during loading or parsing
    def render():
        st.error("🚨 Crawl-X Screen Compiler Diagnostic Crash Log")
        st.markdown("The page failed to execute. Here is the exact underlying error:")
        st.code(str(diagnostic_error), language="python")
